...
def on_programme_complete(bronkhorst_small,
                          bronkhorst_large, 
                          step_label,
                          info_frame, 
                          abort_button, 
...
def flow_controller(bronkhorsts: list[BronkhorstMFC], 
    ...
    for i, (dilution, dilution_flow_set, span, span_flow_set, conc) in enumerate(final_point_list):
        ...
        for t in range(step_time):
            ...
            flow_list_large.append(flow_list_large)
    ...
    on_programme_complete(status_root, bronkhorst_small, bronkhorst_large, info_frame, abort_button, status_root, step_label, end_setpoint_frac)
